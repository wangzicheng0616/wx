			...
			<view class="uni-list-item__container" :class="{ 'container--right': showArrow || link, 'flex--direction': direction === 'column' }">
				<slot name="header">
					<view class="uni-list-item__header">
						<view v-if="thumb" class="uni-list-item__icon"><image :src="thumb" class="uni-list-item__icon-image" :class="['uni-list--' + thumbSize]" /></view>
...
.uni-list-item__icon-image {
	...
	display: block;
	/* #endif */
	height: $uni-image-size-base;
	width: $uni-image-size-base;
	margin-right: 10px;
}
...
.uni-list--lg {
	height: $uni-image-size-lg;
	width: $uni-image-size-lg;
}
...
.uni-list--sm {
	height: $uni-image-size-sm;
	width: $uni-image-size-sm;
}
