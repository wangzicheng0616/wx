<template>
	<view class="uni-load-more" @click="onClick">
		<!-- #ifdef APP-NVUE -->
		<loading-indicator v-if="!webviewHide && status === 'loading' && showIcon" :style="{color: color,width:iconSize+'px',height:iconSize+'px'}" :animating="true" class="uni-load-more__image uni-load-more__image--nvue"></loading-indicator>
		<!-- #endif -->
		<!-- #ifdef H5 -->
		...
		:style="{width:iconSize+'px',height:iconSize+'px'}" class="uni-load-more__image uni-load-more__image--android-H5">
		...
		:style="{width:iconSize+'px',height:iconSize+'px'}" class="uni-load-more__image uni-load-more__image--android-MP">
		...
		<!-- #endif -->
		<!-- #ifndef APP-NVUE -->
		<view v-else-if="!webviewHide && status === 'loading' && showIcon" :style="{width:iconSize+'px',height:iconSize+'px'}" class="uni-load-more__image uni-load-more__image--ios-H5">
...
<style lang="scss" scoped>
	...
	.uni-load-more__image--nvue {
		color: #666666;
	}

	.uni-load-more__image--android,
	.uni-load-more__image--ios {
		width: 24px;
		height: 24px;
	...
	.uni-load-more__image--ios-H5 {
		position: relative;
		animation: loading-ios-H5 1s 0s step-end infinite;
	}

	.uni-load-more__image--ios-H5>image {
		position: absolute;
		width: 100%;
		height: 100%;
		left: 0;
	...
	/* #ifdef H5 */
	.uni-load-more__image--android-H5 {
		animation: loading-android-H5-rotate 2s linear infinite;
		transform-origin: center center;
	}

	.uni-load-more__image--android-H5>circle {
	...
	/* #ifndef APP-NVUE || H5 */
	.uni-load-more__image--android-MP {
		position: relative;
		width: 24px;
		height: 24px;
		transform: rotate(0deg);
	...
	.uni-load-more__image--android-MP>view {
		position: absolute;
	...
	.uni-load-more__image--android-MP>view:nth-child(1){
		animation: loading-android-MP-1 1s 0s linear infinite;
	}

	.uni-load-more__image--android-MP>view:nth-child(2){
		animation: loading-android-MP-2 1s 0s linear infinite;
	}

	.uni-load-more__image--android-MP>view:nth-child(3){
