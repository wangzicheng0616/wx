...
/***/ 0:
/*!****************************************************!*\
  !*** /Users/mima0000/Desktop/交接/绿豆-小程序端前端/main.js ***!
  \****************************************************/
...
var _index2 = _interopRequireDefault(__webpack_require__(/*! ./store/index */ 43));
...
var _config = _interopRequireDefault(__webpack_require__(/*! ./common/config.js */ 80));
var _common = _interopRequireDefault(__webpack_require__(/*! ./common/common.js */ 81));
var _tools = __webpack_require__(/*! ./utils/tools.js */ 87);
...
_vue.default.prototype.tools = _tools.tools;
...
_vue.default.prototype.httpImageUrl = _global.default.imageUri + 'upload_file/uploadfile';
...
Array.prototype.del = function (n) {
  ...
  if (n < 0)
    //如果n<0，则不进行任何操作。
    return this;else return this.slice(0, n).concat(this.slice(n + 1, this.length));
  /*
...
//获取当前路径
_vue.default.prototype.getPath = function () {
...
//微信小程序分享
_vue.default.prototype.getMiniShareObj = function (title, path, imageUrl) {
  var sharePath = '';
  var shareImageUrl = '';
  ...
  if (getApp().globalData.shareImage) {
    shareImageUrl = _tools.tools.getImagePath(getApp().globalData.shareImage);
  }
  return {
...
/***/ 37:
/*!****************************************************!*\
  !*** /Users/mima0000/Desktop/交接/绿豆-小程序端前端/App.vue ***!
  \****************************************************/
/*! no static exports found */
...
/* harmony import */ var _App_vue_vue_type_style_index_1_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./App.vue?vue&type=style&index=1&lang=css& */ 48);
...
/***/ 38:
/*!*****************************************************************************!*\
  !*** /Users/mima0000/Desktop/交接/绿豆-小程序端前端/App.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _default = {
  ...
  onLaunch: function onLaunch(options) {
    ...
    if (_global.default.platform == 1) {//公众号
      // _this.wxAuthorize();
    } else if (_global.default.platform == 0) {
  ...
  methods: {
    getShareConfig: function getShareConfig() {
      ...
      _api.default.globleData.getListByGroupNo({
        groupNo: 'SHARE_CONFIG'
      }).then(function (res) {
        if (res.listData && res.listData.length > 0) {
          var share = res.listData.find(function (item) {
            return item.number == 'SHARE_CONFIG';
          });
          _this2.globalData.shareTitle = share.name;
          _this2.globalData.shareImage = share.data;
        }
      });
    },
    ...
    //获得页面url参数
    getPageParams: function getPageParams(name) {
...
/***/ 46:
/*!**************************************************************************************!*\
  !*** /Users/mima0000/Desktop/交接/绿豆-小程序端前端/App.vue?vue&type=style&index=0&lang=scss& ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 48:
/*!*************************************************************************************!*\
  !*** /Users/mima0000/Desktop/交接/绿豆-小程序端前端/App.vue?vue&type=style&index=1&lang=css& ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
