<template>
	<view class="u-viewider" :style="{
		height: height == 'auto' ? 'auto' : height + 'rpx',
		backgroundColor: bgColor,
		marginBottom: marginBottom + 'rpx',
		marginTop: marginTop + 'rpx'
	}" @tap="click">
		<view class="u-viewider-line" :class="[type ? 'u-viewider-line--bordercolor--' + type : '']" :style="[lineStyle]"></view>
		<view v-if="useSlot" class="u-viewider-text" :style="{
			color: color,
 ...
 * @tutorial https://www.uviewui.com/components/viewider.html
 ...
 * @property {String} bg-color 整个viewider的背景颜色（默认呢#ffffff）
 * @property {String Number} height 整个viewider的高度，单位rpx（默认40）
 ...
 * @example <u-viewider color="#fa3534">长河落日圆</u-viewider>
 */
export default {
	name: 'u-viewider',
	props: {
		// 单一边viewider横线的宽度(数值)，单位rpx。或者百分比
		halfWidth: {
			type: [Number, String],
			default: 150
		},
